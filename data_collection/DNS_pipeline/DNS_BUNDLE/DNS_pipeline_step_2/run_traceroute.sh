...
cd ./step4_traceroute
screen -m -d bash -c "date >> traceroute_logs; bash collect_traceroutes.sh $RETRIES $TIMEOUT;date >> traceroute_logs; dig +retry=5 +short myip.opendns.com @resolver1.opendns.com >> traceroute_logs;"
cd ..
echo '*************************************************'
