...
urlList is a file where each line is one of the following:
  - a URL, which is loaded using DNS resolution;
  - a space seperated pair of a URL and an IP address, which sends a
       GET request for that URL to that IP address, skipping DNS
       resolution; or
