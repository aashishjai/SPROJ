...
#define SCAMPER_DO_TRACELB_ATTEMPTS_DEF    3
#define SCAMPER_DO_TRACELB_ATTEMPTS_MAX    10
...
#define SCAMPER_DO_TRACELB_GAPLIMIT_DEF    30
#define SCAMPER_DO_TRACELB_GAPLIMIT_MAX    35
